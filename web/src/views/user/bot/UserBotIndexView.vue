...
export default {
    ...
    setup() {
        ...
        const add_bot = () => {
            console.log("add_bot called");
            console.log("token:", store.state.user.token);
            console.log("title:", botadd.title, "content:", botadd.content);
            botadd.error_message = "";
            if (!botadd.title.trim() || !botadd.content.trim()) {
                botadd.error_message = "名称和代码不能为空";
                console.log("表单校验未通过");
                return;
            }
            $.ajax({
                ...
                success(resp) {
                    ...
                    if (resp.error_message === "success") {
                        ...
                        console.log("add_bot error_message:", resp.error_message);
                    }
                },
                error(err) {
                    console.log("add_bot ajax error:", err);
                    botadd.error_message = "网络错误，请稍后重试";
                }
            })
        }
